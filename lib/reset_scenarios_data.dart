...
const resetScenarios = [
  ResetScenario(
    ...
    durationMinutes: 3,
    description: 'Короткая пауза, чтобы снизить напряжение и дать телу отдых.',
    steps: [
  ...
  ResetScenario(
    ...
    durationMinutes: 10,
    description: 'Более длинная пауза, чтобы восстановить ресурс перед делами.',
    steps: [
  ...
  ResetScenario(
    ...
    durationMinutes: 5,
    description:
        'Короткий сценарий для снижения тревоги и возвращения контроля.',
    steps: [
  ...
  ResetScenario(
    ...
    durationMinutes: 10,
    description: 'Спокойный reset, чтобы снизить тревогу и собрать план.',
    steps: [
  ...
  ResetScenario(
    ...
    durationMinutes: 3,
    description: 'Быстро вынести задачи из головы и снизить ощущение завала.',
    steps: [
  ...
  ResetScenario(
    ...
    durationMinutes: 5,
    description: 'Короткая подготовка, чтобы снизить суету перед разговором.',
    steps: [
  ...
  ResetScenario(
    ...
    durationMinutes: 3,
    description:
        'Короткий reset, чтобы выйти из напряжения после сложного контакта.',
    steps: [
  ...
  ResetScenario(
    ...
    durationMinutes: 5,
    description:
        'Сценарий, чтобы снизить напряжение и отделить себя от разговора.',
    steps: [
      ...
      'Выбери мягкое действие для восстановления.',
    ],
  ),
  ResetScenario(
    ...
    durationMinutes: 10,
    description:
        'Более полный reset после напряжённого или болезненного общения.',
    steps: [
